...
Cette image de veille sert directement l'autonomie. L'écran étant émissif, un pixel noir n'émet aucune lumière et ne consomme rien, de sorte qu'une trame presque entièrement noire ne coûte que le courant de repos de la dalle et la poignée de pixels gris de l'indication. Seul le bouton de validation réveille l'écran et tout autre bouton est ignoré, ce qui neutralise les appuis accidentels en poche. La lecture audio et le réglage de volume, portés par d'autres tâches, reste fonctionnels.
