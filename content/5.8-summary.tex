...
Le séquencement d'activation et d'extinction de la chaîne filaire ne se vérifie que par l'écoute. Il a été contrôlé lors de la campagne de validation, sur l'ensemble des transitions susceptibles de produire un bruit de commutation, et les constats sont rapportés à la section~\ref{sec:res_firmware}.