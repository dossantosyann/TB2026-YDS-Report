...
Deux cellules Jauch Quartz ont été retenues qui rentrent dans l'empreinte du PCB et ne se distinguent l'une de l'autre que par leur épaisseur, la LP103450JH de 1900~mAh pour 10,0~mm~\cite{jauch_LP103450JH} et la LP523450JU de 950~mAh pour 5,4~mm~\cite{jauch_LP523450JU}. La première double la capacité mais ajoute 4,6 mm à un boîtier déjà épais, alors que le caractère portatif de l'appareil figure au cahier des charges au même titre que l'autonomie. La LP523450JU a donc été retenue, sa disponibilité dans le stock de l'école ayant en outre permis de mener la mise en service sans attendre un approvisionnement.

Deux caractéristiques de la cellule contraignent enfin le reste de l'alimentation. Ses courants admissibles sont limités à 1~C, soit 950~mA, ce qui plafonne le courant de charge qui sera délivré par le composant choisi à la section suivante. Sa protection intégrée détecte par ailleurs la décharge profonde à 3,00~V, en dessous du seuil de 3,20~V du superviseur présenté à la section~\ref{sec:superviseur}, de sorte que le système s'arrête toujours avant que la cellule ne se verrouille d'elle-même.
