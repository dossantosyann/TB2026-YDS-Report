...
\fig[H, width=0.7\textwidth]{Reconstitution de la fin de la session précédente. Les deux témoins sont exclusifs, un plantage n'atteignant jamais le code qui écrit le marqueur. Diagramme créé avec l'aide de Claude Opus 4.8.}{verdict_extinction.drawio}
